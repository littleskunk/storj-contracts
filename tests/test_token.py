...
def test_increase_approval(token: Contract, customer: str, empty_address: str, allowed_party):
    """Increase approval."""
...
def test_decrease_approval(token: Contract, customer: str, empty_address: str, allowed_party):
    """Decrease approval."""
